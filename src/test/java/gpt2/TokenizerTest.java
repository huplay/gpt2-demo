...
{
    private static final Tokenizer tokenizer = new Tokenizer(System.getProperty("user.dir") + "/parameters");
    ...
    public void testEncoder(String text, Integer... tokens)
    {
        List<Integer> tokenList = Arrays.asList(tokens);
        assertEquals(tokenList, tokenizer.encode(text));
    }

    public void testDecoder(String text, Integer... tokens)
    {
        List<Integer> tokenList = Arrays.asList(tokens);
